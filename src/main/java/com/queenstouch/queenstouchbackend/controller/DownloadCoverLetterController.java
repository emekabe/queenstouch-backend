...
@Tag(name = "Cover Letter", description = "AI-assisted cover letter builder")
@SecurityRequirement(name = "bearerAuth")
public class DownloadCoverLetterController {

    private final DocumentGeneratorService documentGeneratorService;

    @GetMapping("/{id}/download")
    @Operation(
        summary = "Download a Cover Letter as PDF or DOCX",
        description = "Requires a paid order referencing this Cover Letter. Returns the file as a download attachment."
    )
    public ResponseEntity<byte[]> download(
        ...
        DocumentGeneratorService.GeneratedDocument doc =
                documentGeneratorService.generateCoverLetter(email, id, fmt);
